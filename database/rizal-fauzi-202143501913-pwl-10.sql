...
-- Dumping data for table perpustakaan.books: ~0 rows (approximately)

-- Dumping structure for table perpustakaan.currency
...
-- Dumping data for table perpustakaan.currency: ~113 rows (approximately)
...
-- Dumping structure for table perpustakaan.login_session
...
-- Dumping data for table perpustakaan.login_session: ~0 rows (approximately)
