...
export default function TableComponent({ arr_element, is_completed, on_click_is_read,set_modal_edit,set_modal_delete }) {
          ...
          return (
            <tr key={item.id} className="bg-gray-100 dark:bg-slate-600 border-b transition duration-300 ease-in-out hover:bg-gray-200 dark:hover:bg-gray-800">
              ...
              <td className="td_tbody">
                ...
                <button type="button" className="btn btn_warning w-full mb-3" onClick={set_modal_edit.bind(this, { show: true, book_id: item.id })}>
                  <i className="bi bi-pencil-fill text-white"></i>
                </button>
                <button type="button" className="btn btn_reset w-full" onClick={set_modal_delete.bind(this, { show: true, book_id: item.id })}>
